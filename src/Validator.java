...
public class Validator {
    ...
    public static String validateString(String prompt, String invalidPrompt, String valid1, String valid2) {
    ...
    public static String validateString(String prompt, String invalidPrompt, String valid1, String valid2, String valid3) {
        boolean isValid = false;
        String s = "";
        while (isValid == false) {
            System.out.print(prompt);
    ...
    public static int validateInt(String prompt, String invalidPrompt, int min, int max) {
        int i = 0;
        boolean isValid = false;
        while (isValid == false) {
            i = validateInt(prompt);
            if (i < min)
                System.out.print(invalidPrompt);
            else if (i > max)
                System.out.print(invalidPrompt);
